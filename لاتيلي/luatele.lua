...
--local LuaTele =  require(SendTg('bHVhZ3JhbQ==')) 
...
function luatele_function.vardump(input)
  ...
  print(luatele_function.colors('%{underline} Method information : %{reset}\n\n%{yellow}'..vardump(input)))
...
function luatele.VERSION()
  print(luatele_function.colors('%{green}\27[5m'..luatele.logo..'\n'..luatele_function.base64_decode('dGhpcyBmaWxlcyB3YXMgd3JpdHRlbiBieSBATWFobW91ZE0yICYgQFU2NjBw')))
  return true
end
